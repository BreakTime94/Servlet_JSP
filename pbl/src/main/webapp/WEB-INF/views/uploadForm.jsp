	...
	<div class="container">
		<div class="d-grid my-2 attach-area">
			...
			<ul class="list-group my-3 attach-list">
				<li class="list-group-item d-flex align-items-center justify-content-between"><span>First item</span><i class="fa-solid fa-circle-xmark float-end text-danger"></i></li>
				<li class="list-group-item d-flex align-items-center justify-content-between"><span>Second item</span><i class="fa-solid fa-circle-xmark float-end text-danger"></i></li>
				<li class="list-group-item d-flex align-items-center justify-content-between"><span>Third item</span><i class="fa-solid fa-circle-xmark float-end text-danger"></i></li>
			</ul>
